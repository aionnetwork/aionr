...
impl RlpStream {
    ...
    pub fn len<'a>(&'a self) -> usize { self.estimate_size(0) }
    ...
    ///     assert_eq!(out, vec![0xc8, 0x83, b'c', b'a', b't', 0x83, b'd', b'o', b'g']);
    /// }
    pub fn is_finished(&self) -> bool { self.unfinished_lists.len() == 0 }
    ...
    pub fn encoder(&mut self) -> BasicEncoder { BasicEncoder::new(self) }
