...
mod tests {
    ...
    fn test_1million_random_md5() {
        let mut sh = Md5::new();
        test_digest_1million_random(&mut sh, 64, "7707d6ae4e027c70eea2a935c2296f21");
    }
    ...
    pub fn benchtest_md5_10() {
        ...
        println!(
            "[benchtest_md5_10] md5 10 (ns/call): {}",
    ...
    pub fn benchtest_md5_1k() {
        ...
        let took = time.elapsed();
        println!(
            "[benchtest_md5_1k] md5 1k (ns/call): {}",
            (took.as_secs() * 1000_000_000 + took.subsec_nanos() as u64) / count
        );
    }
    ...
    pub fn benchtest_md5_64k() {
        ...
        let took = time.elapsed();
        println!(
            "[benchtest_md5_64k] md5 64k (ns/call): {}",
            (took.as_secs() * 1000_000_000 + took.subsec_nanos() as u64) / count
        );
    }
}
