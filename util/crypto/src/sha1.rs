...
#[inline]
pub fn sha1_first(w0: u32x4) -> u32 { w0.0 }
...
mod tests {
    ...
    pub fn benchtest_sha1_block() {
        ...
        println!(
            "[benchtest_sha1_block] sha1 block (ns/call): {}",
    ...
    pub fn benchtest_sha1_10() {
        ...
        let took = time.elapsed();
        println!(
            "[benchtest_sha1_10] sha1 10 (ns/call): {}",
            (took.as_secs() * 1000_000_000 + took.subsec_nanos() as u64) / count
        );
    }
    ...
    pub fn benchtest_sha1_1k() {
        ...
        let took = time.elapsed();
        println!(
            "[benchtest_sha1_1k] sha1 1k (ns/call): {}",
            (took.as_secs() * 1000_000_000 + took.subsec_nanos() as u64) / count
        );
    }
    ...
    pub fn benchtest_sha1_64k() {
        ...
        let took = time.elapsed();
        println!(
            "[benchtest_sha1_64k] sha1 64k (ns/call): {}",
            (took.as_secs() * 1000_000_000 + took.subsec_nanos() as u64) / count
        );
    }
}
