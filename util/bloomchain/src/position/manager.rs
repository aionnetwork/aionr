...
impl Manager {
    ...
    pub fn level_size(&self, level: usize) -> usize { self.level_sizes[level as usize] }
    ...
    pub fn levels(&self) -> usize { self.level_sizes.len() }

    /// Returns max indexer level.
    pub fn max_level(&self) -> usize { self.level_sizes.len() - 1 }
}
