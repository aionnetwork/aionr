...
use kvdb::MemoryDB;
use rlp::RlpStream;
use trie::{self, Recorder, Trie, TrieMut};
use trie::{TrieDB, TrieDBMut};
...
pub fn build<F>(cht_num: u64, mut fetcher: F) -> Option<CHT>
...
pub fn check_proof(_proof: &[Bytes], _num: u64, _root: H256) -> Option<(H256, U256)> { None }
...
pub fn start_number(cht_num: u64) -> u64 { (cht_num * SIZE) + 1 }
