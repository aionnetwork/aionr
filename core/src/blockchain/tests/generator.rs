...
impl Block {
    ...
    #[inline]
    pub fn encoded(&self) -> Bytes { encode(self).into_vec() }

    #[inline]
    pub fn difficulty(&self) -> U256 { *self.header.difficulty() }
}
...
impl BlockGenerator {
    ...
    where T: IntoIterator<Item = BlockBuilder> {
        BlockGenerator {
