...
mod test {
    ...
    ) -> ReturnDataFromSetup
    {
        ...
        assert!(transfer_result.status_code == EvmStatusCode::Success);
    ...
    fn atb_test_transfer() {
        ...
        let contract = get_contract();
        {
            ...
            assert!(call_result.status_code == EvmStatusCode::Success);
    ...
    fn atb_test_transfer_not_replayer() {
        ...
        assert!(transfer_result.status_code == EvmStatusCode::Failure);
    }
    ...
    fn transfer_ring_locked() {
        ...
        assert!(res.status_code == EvmStatusCode::Success);
        ...
        let res = contract.execute(&mut ext, input_data.as_slice());
        assert!(res.status_code == EvmStatusCode::Failure);
    ...
    fn test_transfer_invalid_relayer() {
        ...
        assert!(tx_res.status_code == EvmStatusCode::Failure);
    ...
    fn test_transfer_fail_length() {
        ...
        for _ in 1..404 {
            ...
            assert!(transfer_result2.status_code == EvmStatusCode::Failure);
            i = i + 1;
        }
        ...
        assert!(transfer_result2.status_code == EvmStatusCode::Success);
    }
    ...
    fn test_fail_ring_initialize() {
        ...
        assert!(result2.status_code == EvmStatusCode::Failure);
    }
    ...
    fn tset_add_ring_member() {
        ...
        assert!(result3.status_code == EvmStatusCode::Success);
    }
    ...
    fn tset_remove_ring_member() {
        ...
        payload3.extend_from_slice(generate_keypair().address().as_ref());
        let result3 = contract.execute(&mut ext, &payload3);
        assert!(result3.status_code == EvmStatusCode::Failure);
        ...
        assert!(result4.status_code == EvmStatusCode::Success);
    }
    ...
    fn tset_remove_ring_member_not_owner() {
        ...
        let payload4 = "67a3914ea092c2138fd623b3933c749c7ca26c0269ab377b20cde2cbdd3f0b9a0b59b42f"
            ...
            .unwrap();
        let result4 = contract.execute(&mut ext, &payload4);
        assert!(result4.status_code == EvmStatusCode::Failure);
    }
