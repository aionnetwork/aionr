...
mod tests {
    ...
    fn test_no_state_root() {
        let expected = ::rustc_hex::FromHex::from_hex("").unwrap();
        let r = Receipt::new(
            H256::zero(),
            0x40cae.into(),
            U256::zero(),
    ...
    #[test]
    fn test_basic() {
        let expected = ::rustc_hex::FromHex::from_hex("").unwrap();
        let r = Receipt::new(
