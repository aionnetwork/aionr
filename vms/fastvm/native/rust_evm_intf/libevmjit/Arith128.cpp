...
Arith128::Arith128(IRBuilder& _builder) :
	CompilerHelper(_builder)
{}

void Arith128::debug(llvm::Value* _value, char _c, llvm::Module& _module, IRBuilder& _builder)
{
...
llvm::Function* Arith128::getUDivRem128Func(llvm::Module& _module)
{
	static const auto funcName = "evm.udivrem.i128";
...
llvm::Function* Arith128::getUDivRem256Func(llvm::Module& _module)
{
	static const auto funcName = "evm.udivrem.i256";
	if (auto func = _module.getFunction(funcName))
		return func;

	return createUDivRemFunc(llvm::IntegerType::get(_module.getContext(), 256), _module, funcName);
}

llvm::Function* Arith128::getUDiv128Func(llvm::Module& _module)
{
	static const auto funcName = "evm.udiv.i128";
	if (auto func = _module.getFunction(funcName))
		return func;

	auto udivremFunc = getUDivRem128Func(_module);
...
{
	auto udivremFunc = _type == Type::Word ? Arith128::getUDivRem128Func(_module) : Arith128::getUDivRem256Func(_module);
...
llvm::Function* Arith128::getURem128Func(llvm::Module& _module)
{
	static const auto funcName = "evm.urem.i128";
	if (auto func = _module.getFunction(funcName))
		return func;
	return createURemFunc(Type::Word, _module, funcName);
}

llvm::Function* Arith128::getURem256Func(llvm::Module& _module)
{
	static const auto funcName = "evm.urem.i256";
	if (auto func = _module.getFunction(funcName))
		return func;
	return createURemFunc(llvm::IntegerType::get(_module.getContext(), 256), _module, funcName);
}

llvm::Function* Arith128::getSDivRem128Func(llvm::Module& _module)
{
	static const auto funcName = "evm.sdivrem.i128";
	if (auto func = _module.getFunction(funcName))
		return func;
...
llvm::Function* Arith128::getSDiv128Func(llvm::Module& _module)
{
	static const auto funcName = "evm.sdiv.i128";
	if (auto func = _module.getFunction(funcName))
		return func;

	auto sdivremFunc = getSDivRem128Func(_module);
...
llvm::Function* Arith128::getSRem128Func(llvm::Module& _module)
{
	static const auto funcName = "evm.srem.i128";
	if (auto func = _module.getFunction(funcName))
		return func;
...
llvm::Function* Arith128::getExpFunc()
{
	if (!m_exp)
	{
...
llvm::Value* Arith128::exp(llvm::Value* _arg1, llvm::Value* _arg2)
{
	//	while (e != 0) {
	//		if (e % 2 == 1)
	//			r *= b;
