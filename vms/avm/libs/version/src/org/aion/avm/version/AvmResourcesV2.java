 ...
 */
public final class AvmResourcesV2 implements Closeable {
    private final URLClassLoader classLoader;
    // public final IAvmResourceFactory resourceFactory;
    // private AionVirtualMachine avm;

    private AvmResourcesV2(URLClassLoader classLoader) {
     ...
     */
    public static AvmResourcesV2 loadResources(String projectRootDir) throws IllegalAccessException, ClassNotFoundException, InstantiationException, IOException {
        System.out.println("AvmVersoin2: load resources from " + projectRootDir);
        URLClassLoader classLoader = newClassLoaderForAvmVersion2(projectRootDir);
        return new AvmResourcesV2(classLoader);
    }
