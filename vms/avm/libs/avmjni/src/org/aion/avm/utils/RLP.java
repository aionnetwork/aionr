...
public class RLP {
    ...
    public static byte[] encodeBigInteger(BigInteger srcBigInteger) {
        if (srcBigInteger.equals(BigInteger.ZERO)) {
            ...
            return encodeElement(Utils.asUnsignedByteArray(srcBigInteger));
        }
    }
    ...
    private static byte[] toBytes(Object input) {
        if (input instanceof byte[]) {
            ...
            return (inputByte == 0)
                    ...
                    : Utils.asUnsignedByteArray(BigInteger.valueOf(inputByte));
        } else if (input instanceof Short) {
            Short inputShort = (Short) input;
            return (inputShort == 0)
                    ? ByteUtil.EMPTY_BYTE_ARRAY
                    : Utils.asUnsignedByteArray(BigInteger.valueOf(inputShort));
        } else if (input instanceof Integer) {
            Integer inputInt = (Integer) input;
            return (inputInt == 0)
                    ? ByteUtil.EMPTY_BYTE_ARRAY
                    : Utils.asUnsignedByteArray(BigInteger.valueOf(inputInt));
        } else if (input instanceof Long) {
            Long inputLong = (Long) input;
            return (inputLong == 0)
                    ? ByteUtil.EMPTY_BYTE_ARRAY
                    : Utils.asUnsignedByteArray(BigInteger.valueOf(inputLong));
        } else if (input instanceof BigInteger) {
            BigInteger inputBigInt = (BigInteger) input;
            return (inputBigInt.equals(BigInteger.ZERO))
                    ? ByteUtil.EMPTY_BYTE_ARRAY
                    : Utils.asUnsignedByteArray(inputBigInt);
