...
public:
	...
	/// if @a _pad then add padding to multiples of 16 bytes for calldata/memory.
	/// Stack pre: length
	/// Stack post: size
...
private:
	...
	/// the storage offset if adding this number again would increase the counter over 16.
